    ...
    public static void main(String[] args) {
        ...
        gamePanel.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                    ...
                    for (int i = 0; i < enemies.size(); i++) {
                        ...
                        if (enemy.getX() == player.getX() && enemy.getY() == player.getY()) {
                            ...
                            if (enemy.isDead()) {
                                ...
                                logPanel.addMessage( " floor you are now is" + gameWorld.getCurrentFloor());
                                player.addXp(10+ gameWorld.getCurrentFloor()); // Ή ό,τι XP θες ανα enemy!
                ...
                if (gameWorld.isPlayerOnExit() && enemies.isEmpty()){                    
