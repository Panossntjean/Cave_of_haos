...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        JOptionPane.showMessageDialog(frame, "Welcome to dungeon Caves of Chaos \nBe prepared for the Worst!\nOnly the strongest survive!","Cave of Chaos....", JOptionPane.INFORMATION_MESSAGE);
        gamePanel.requestFocusInWindow();
        gamePanel.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                ...
                enemies.forEach(en -> occupied[en.getX()][en.getY()] = true);
                ...
                enemies.stream()
                        .filter(en -> Math.abs(en.getX() - player.getX()) < 2
                                    && Math.abs(en.getY() - player.getY()) < 2)
                        .forEach(en -> player.takeDamage(en.getDmg()));
                ...
                //here the stream was not better option than the for loop since we had floorMap is not final cannot use stream.... 
