...
public class Player {
    ...
    private static final int[] Warrior_Base_Hp = {30, 60, 80, 90, 100, 140}; //10000,20000,30000,40000,50000,60000};//
    private static final int[] Warrior_Base_Strength = {10, 20, 20, 30, 35, 45};//1000,1000,1000,1000,1000,1000};//
